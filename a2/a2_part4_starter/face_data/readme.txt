...
testing_scenes:
  These are 130 images from the CMU/MIT frontal face image database.
  http://vasc.ri.cmu.edu/idb/html/face/frontal_images/

  Also included are the ground-truth locations of faces (bounding boxes) in
  each image.

single_scale_scenes:
  These are 83 images selected from the CMU/MIT database.
